...
public class DrivebaseSub extends SubsystemBase{
    ...
    public void teleopDrive(double move, double turn) {
        ...
        SmartDashboard.putNumber("Left Encoder tele", Robot.m_robotContainer.drivebasesub.encoderLeft.getQuadraturePosition());
        SmartDashboard.putNumber("Right Encoder tele", Robot.m_robotContainer.drivebasesub.encoderRight.getQuadraturePosition());
